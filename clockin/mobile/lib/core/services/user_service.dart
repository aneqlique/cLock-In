...
//     final user = (userData['user'] is Map)
//         ? (userData['user'] as Map).cast<String, dynamic>()
//         : userData;

//     await prefs.setString(
//       'token',
//       (userData['token'] ?? user['token'] ?? '').toString(),
//     );
...
//       try { err = jsonDecode(response.body); } catch (_) { err = {}; }
//       final message = (err['message'] ?? 'Login failed').toString();
...
//       Map<String, dynamic> err;
//       try { err = jsonDecode(response.body); } catch (_) { err = {}; }
//       final message = (err['message'] ?? 'Registration failed').toString();
//       throw Exception('Registration failed: ${response.statusCode} $message');
//     }
//   }
